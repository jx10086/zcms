...
<div class="note note-danger">
    <p style="margin-top:5px;"><a href="https://www.xunruicms.com/juan/" target="_blank" style="color: green;">开源是一种精神也是一种奉献，您的帮助是对我们最大的支持和动力</a></p>
</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-green sbold "><?php echo dr_lang('本站信息'); ?></span>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-green sbold ">迅睿CMS框架</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="form-body fc-yun-list">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo dr_lang('框架版本'); ?></label>
                            <div class="col-md-9">
                                <div class="form-control-static"><a href="<?php echo dr_url('cloud/update'); ?>"><?php echo $cmf_version['version']; ?>（<?php echo $cmf_version['updatetime']; ?>）</a></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo dr_lang('官方网站'); ?></label>
                            <div class="col-md-9">
                                <div class="form-control-static"><a href="https://www.xunruicms.com" target="_blank">www.xunruicms.com</a></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo dr_lang('框架创始人'); ?></label>
                            <div class="col-md-9">
                                <div class="form-control-static"><a href="javascript:dr_show_info('联络邮件：finecms@qq.com<br>程序问题或功能建议问题请发送到本邮箱');">PHP码农</a></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo dr_lang('插件研发组'); ?></label>
                            <div class="col-md-9">
                                <div class="form-control-static"><a href="https://www.xunruicms.com/qq/js.html" target="_blank">插件负责人</a></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo dr_lang('技术交流群'); ?></label>
                            <div class="col-md-9">
                                <div class="form-control-static"><a href="https://www.xunruicms.com/qq/qun.html" target="_blank">开发者QQ群</a></div>
                            </div>
                        </div>
