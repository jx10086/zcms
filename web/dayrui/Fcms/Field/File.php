...
class File extends \Phpcmf\Library\A_Field {
	...
	public function input($field, $value = '') {
        ...
        $json = json_encode([
            ...
            'unused_url' => dr_web_prefix('index.php?s=api&c=file&m=input_file_list&p=' . $p . '&fid=' . $field['id']),
            'input_url' => dr_web_prefix('index.php?s=api&c=file&m=input_file_url&token='.dr_get_csrf_token().'&siteid='.SITE_ID.'&p='.$p.'&fid='.$field['id'].'&file='.$file_url.'&one=1'),
            'tpl' => $tpl,
