...
class Code extends \Phpcmf\Model
{
    ...
    public function get_field_code($field, $type, $rt = '', $fname = '', $fixid = 0) {
        ...
        $code = str_replace(
            ['{SELF}','MOD_DIR', PHP_EOL, '$value', '$id', '$fid', '$time', '$linkname', '$module', '$fixid'],
            [SELF, defined('MOD_DIR') ? MOD_DIR : '', '<br>', $name, $name, $field['id'], $time, $field['setting']['option']['linkage'], $field['setting']['option']['module'], $fixid],
