<?php if ((SYS_HTTPS && substr($url, 0, 7) == "http://")) { ?>
<html>
<head>
...
<div style="<?php if (\Phpcmf\Service::IS_MOBILE_USER()) { ?> padding:100px 10px 10px 10px; <?php } else { ?>padding:220px;<?php } ?>text-align: center">
    <a href="<?php echo $url; ?>" target="_blank" class="btn default btn-block "><?php echo dr_lang('单击下方链接进行访问该页面'); ?></a>
</div>
</body>
</html>
<?php } else if (IS_DEV) { ?>
...
<body class="page-content-white">
<div style="<?php if (\Phpcmf\Service::IS_MOBILE_USER()) { ?> padding:100px 10px 10px 10px; <?php } else { ?>padding:220px;<?php } ?>text-align: center">
    <a href="<?php echo $url; ?>" class="btn default btn-block"><?php echo dr_lang('单击下方链接进行访问该页面'); ?></a>
    <p><?php echo $url; ?></p>
</div>
</body>
</html>
